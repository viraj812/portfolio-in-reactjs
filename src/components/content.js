...
const TypewriterAnimation = (props) => {
  ...
  return <span className='name-span'>{currentText}</span>;
};
    ...
    <div className='contentDiv'>
      <div className='contentBox'>
        <h2><span className='pronoun-span'>Hi There, <br />
          I'm </span>
          <TypewriterAnimation text="VIRAJ DESAI" delay={100} />
        </h2>

        <p className='role'><span className='role-span'>Computer Science Engineer</span></p>
